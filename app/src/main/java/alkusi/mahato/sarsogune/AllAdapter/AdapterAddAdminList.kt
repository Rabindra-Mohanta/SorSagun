...
class AdapterAddAdminList(var context: Context, var userList:ArrayList<QueryDocumentSnapshot>, var storageReference: StorageReference?,var listener:OnUserClick):
    RecyclerView.Adapter<AdapterAddAdminList.ViewHolder>() {
